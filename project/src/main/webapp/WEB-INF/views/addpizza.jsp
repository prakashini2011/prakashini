...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <c:url var="addpizza" value="addpizza"></c:url>
   <form:form commandName="Product" method="post" action="storepizza" enctype="multipart/form-data">
       <table class="table table-bordered" >
           ...
           <tr><td><form:label path="lifespan">Lifespan :</form:label></td>
               <td><form:input path="lifespan"/>
               <font color="red"><form:errors path="lifespan"></form:errors></font></td>
           </tr> 
           ...
           <tr><td><form:label path="img">pizza Image:</form:label></td>
